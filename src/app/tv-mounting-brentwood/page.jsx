...
export const metadata = {
  ...
  openGraph: {
    ...
    description: "Professional TV installation and wall mounting services in Brentwood Tennessee. Same-day availability.",
    url: "https://primetvnashville.com/tv-mounting-brentwood",
    siteName: "PrimeTvNashville",
    images: [{ url: "https://primetvnashville.com/og-image.jpg", width: 1200, height: 630, alt: "TV wall mounting service in Brentwood Tennessee" }],
    locale: "en_US",
    type: "website",
  },
  alternates: { canonical: "https://primetvnashville.com/tv-mounting-brentwood" },
};
...
export default function TvMountingBrentwoodPage() {
  ...
  return (
    <>
      ...
      <HeroReusable
        hiddenTitle="TV Mounting Brentwood Tennessee"
        title="Professional TV Mounting in Brentwood TN"
        subtitle="Safe and secure TV wall mounting with clean cable management for homes and businesses in Brentwood."
      />
      <WhyChooseSection />
      <LocalCitySection city="brentwood" />
      <ServicesSection />
      <PricingSection />
      <BookingSteps />
      <CoverageMap />
      <QuickQuoteForm />
      <CityFaqSection city="brentwood" />
      <FaqsSection />
      <StickyActionBar />
    </>
  );
