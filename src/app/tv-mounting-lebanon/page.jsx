...
export const metadata = {
  title: "TV Mounting in Lebanon TN | PrimeTvNashville",
  description: "Professional TV mounting in Lebanon, TN. Secure wall mounting, cable concealment and fireplace TV installs for homes and businesses. Same-day available.",
  ...
  openGraph: {
    ...
    url: "https://www.primetvnashville.com/tv-mounting-lebanon",
    siteName: "PrimeTvNashville",
    images: [{ url: "https://www.primetvnashville.com/opengraph-image", width: 1200, height: 630, alt: "TV wall mounting service in Lebanon Tennessee" }],
    locale: "en_US",
    type: "website",
  },
  alternates: { canonical: "https://www.primetvnashville.com/tv-mounting-lebanon" },
};
...
export default function TvMountingLebanonPage() {
  const jsonLd = {
    ...
    "@type": "Service",
    "name": "TV Mounting in Lebanon, TN",
  ...
  return (
    <>
      ...
      />
      <WhyChooseSection />
      <LocalCitySection city="lebanon" />
      <ServicesSection />
      <PricingSection />
      <BookingSteps />
      <CoverageMap />
      <QuickQuoteForm />
      <CityFaqSection city="lebanon" />
      <FaqsSection />
      <StickyActionBar />
    </>
  );
