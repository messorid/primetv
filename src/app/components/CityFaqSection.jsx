const CITY_FAQS = {
  nashville: [
    ...
    { q: "Can you mount a TV above a fireplace in a Nashville home?", a: "Yes. Fireplace mounting starts from $25 extra, and the final price depends on the difficulty and the mount used. We check heat clearance, choose the safest height, and ensure cables are properly managed. Very common in Nashville living rooms." },
    ...
    { q: "Can you hide TV cables in a Nashville home?", a: "Yes. Cable concealment starts at $60 per TV, depending on the wall and the length of the run. We use an in-wall power kit or a surface raceway depending on your wall type. Most Nashville drywall walls qualify for in-wall routing." },
  ],
  brentwood: [
    ...
    { q: "Do you mount TVs above fireplaces in Brentwood?", a: "Yes. Many Brentwood homes have stone or brick fireplaces. We handle hard wall surfaces with a surcharge starting at $25 and always verify safe heat clearance before mounting." },
  ...
  franklin: [
    ...
    { q: "Can you mount a TV above a fireplace in Franklin?", a: "Yes. Fireplace mounting starts from $25 extra, and the final price depends on the difficulty and the mount used. We check heat clearance based on your fireplace type and TV model before committing to a mounting height." },
  ...
  murfreesboro: [
    ...
    { q: "Can you hide cables in a Murfreesboro home?", a: "Yes. Cable concealment starts at $60 per TV, depending on the wall and the length of the run. Most drywall homes in Murfreesboro qualify for full in-wall cable routing for a clean, professional finish." },
  ],
  smyrna: [
    ...
    { q: "Do you mount TVs above fireplaces in Smyrna homes?", a: "Yes. Fireplace mounting starts from $25 extra, and the final price depends on the difficulty and the mount used. We check heat clearance and choose the right height before drilling." },
  ...
  hendersonville: [
    ...
    { q: "Do you mount TVs on brick or stone walls in Hendersonville?", a: "Yes. Many Hendersonville homes have brick or stone walls. Hard surfaces carry a surcharge starting at $25. The result is perfectly secure and clean." },
    { q: "Can you hide TV cables in a Hendersonville home?", a: "Yes. Cable concealment starts at $60 per TV, depending on the wall and the length of the run. In-wall routing works great in most Hendersonville drywall homes." },
  ...
  gallatin: [
    ...
    { q: "Can you mount a TV above a fireplace in Gallatin?", a: "Yes. Fireplace mounting starts from $25 extra, and the final price depends on the difficulty and the mount used. We verify heat clearance and pick the safest height for your setup." },
  ...
  goodlettsville: [
    ...
    { q: "Can you hide TV cables in Goodlettsville?", a: "Yes. Cable concealment starts at $60 per TV, depending on the wall and the length of the run. In-wall routing is available for standard drywall homes throughout Goodlettsville." },
    { q: "Do you mount TVs over fireplaces in Goodlettsville?", a: "Yes. Fireplace mounting is available with a surcharge starting at $25. We check heat clearance and choose the right height every time." },
  ],
  "la-vergne": [
    ...
    { q: "Can you hide cables in a La Vergne home?", a: "Yes. Cable concealment starts at $60 per TV, depending on the wall and the length of the run. Most La Vergne homes qualify for in-wall routing." },
  ...
  lebanon: [
    ...
    { q: "Can you hide cables in a Lebanon TN home?", a: "Yes. Cable concealment starts at $60 per TV and is available for drywall homes throughout Lebanon." },
  ...
  "mount-juliet": [
    ...
    { q: "Can you mount a TV above a fireplace in Mount Juliet?", a: "Yes. Fireplace mounting starts from $25 extra, and the final price depends on the difficulty and the mount used. We verify heat clearance and choose the safest height before drilling." },
  ...
  nolensville: [
    ...
    { q: "Can you mount a TV above a fireplace in Nolensville?", a: "Yes. Fireplace mounting is very common in Nolensville homes. Starts from $25 extra with a full heat clearance check; pull-down mantel mounts are quoted separately." },
    { q: "Can you hide cables in a Nolensville home?", a: "Yes. Cable concealment starts at $60 per TV, depending on the wall and the length of the run. Most Nolensville homes have drywall that qualifies for full in-wall routing." },
